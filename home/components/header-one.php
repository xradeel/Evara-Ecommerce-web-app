        ...
        <div class="header-nav d-none d-lg-flex">
          <div class="main-categori-wrap d-none d-lg-block">
            ...
            <div class="categori-dropdown-wrap categori-dropdown-active-large">
              <ul>
                <li>
                  <a href="shop-fullwidth.php"><i class="evara-font-dress"></i>Women's Clothing</a>
                </li>
                <li>
                  <a href="shop-fullwidth.php"><i class="evara-font-tshirt"></i>Men's Clothing</a>
                </li>
                <li>
                  <a href="shop-fullwidth.php"><i class="evara-font-diamond"></i>Jewelry &
                    Accessories</a>
                </li>
                <li>
                  <a href="shop-fullwidth.php"><i class="evara-font-high-heels"></i>Shoes</a>
                </li>
                <li>
                  <a href="shop-fullwidth.php"><i class="evara-font-kite"></i>Outdoor fun</a>
                </li>
                <li>
                  <ul class="more_slide_open" style="display: none">
                    <li>
                      <a href="shop-fullwidth.php"><i class="evara-font-desktop"></i>Beauty, Health</a>
                    </li>
                    <li>
                      <a href="shop-fullwidth.php"><i class="evara-font-cpu"></i>Bags</a>
                    </li>
                  </ul>
                </li>
              </ul>
